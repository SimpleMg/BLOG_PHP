                    ...
                    <nav class="navbar navbar-expand-lg navbar-light w-100">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a class="nav-link" href="../../Blog_soutenance/user/login_user.php">Connexion user</a></li>
                                <li class="nav-item"><a class="nav-link" href="../../Blog_soutenance/admin/login_admin.php">Connexion admin</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
