...
<div class="grid_10">
    ...
    <div class="box round first grid">
        ...
        else
        {
            ...
            echo var_dump($_FILES['image']['tmp_name']);
            ...
            if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
            {
                ...
                {
                    $queryU = "INSERT INTO post(category_id, title, body, image, author, tags, user_id) VALUES($category_id,'$title','$body','$strQue','$author','$tags', 2)";
